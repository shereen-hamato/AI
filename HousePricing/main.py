...
try:
    ...
    print("Training data...")
    # Train models
    models = train.train_all_models(prepared_data, labels)

    # Evaluate
    print("Validate data...")
    evaluate.cross_validate_models(models, prepared_data, labels)

    # Fine-tune best models
    print("Fine tune data...")
    best_model, feature_importances = train.grid_search_best(prepared_data, labels, models[2])

    # Save
    print("Save model...")
    os.makedirs("models", exist_ok=True)
    save_load.save_models(models, best_model)
